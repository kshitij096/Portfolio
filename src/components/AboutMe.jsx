...
const About = () => {
  return (
    ...
    >
      <div className=" flex flex-col lg:flex-row   max-w-7xl px-4 sm:px-6 sm:mx-16    lg:px-8 mt-10 mb-10 text-center md:mx-1  lg:h-[350px] ">
        <div className="md:w-2/2  mx-auto mb-10 lg:mb-0 sm:w-2/2 ">
          <img
            className="rounded-3xl w-[400px] h-[250px]  sm:w-[400px] sm:h-[350px] mx-auto lg:mx-0   lg:h-full"
            src={AboutImg}
            alt="About Img"
          />
        </div>
        <div className="flex flex-col lg:w-2/3  lg:pl-8 md:mx-[7rem] lg:mx-0">
